"""
Disease metadata registry — mirrors DiagnosisResult class from Colab notebook.
Maps CLASS_ORDER_KEYS → full disease info used by DiagnosisResult.build_response().
"""
